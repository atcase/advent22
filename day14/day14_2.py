...
# add the floor
cave_height = ymax - ymin + 1
floor_width = cave_height
floor_path = [[500 - cave_height - 1, ymax + 2], [500 + cave_height + 1, ymax + 2]]
paths.append(floor_path)
xmin = min(xmin, 500 - cave_height - 1)
xmax = max(xmax, 500 + cave_height + 1)
ymax = ymax + 2
